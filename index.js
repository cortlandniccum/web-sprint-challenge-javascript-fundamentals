...
//this is cool because it is a lot faster doing it this way than using a for loop
// let sum = 0;
//   for (let i = 1; i <= number; i++) {
//     sum += i;
//   }
//   return sum;
// it accomplished the same result but less typing!!
...
function lowPopulationAnimals(item) {
  const lowpopulation = item.filter(function (item) {
...
function USApop(item) {
  const totalPop = item.reduce(function (acc, item) {
